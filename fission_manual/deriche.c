...
#pragma omp parallel
{
   #pragma omp for nowait private(i, j, ym1, ym2, xm1)
   for (i=0; i<_PB_W; i++) {
        ym1 = SCALAR_VAL(0.0);
        ym2 = SCALAR_VAL(0.0);
        xm1 = SCALAR_VAL(0.0);
   ...
   #pragma omp for private(i, j, yp1, yp2, xp1, xp2)
    for (i=0; i<_PB_W; i++) {
        yp1 = SCALAR_VAL(0.0);
        yp2 = SCALAR_VAL(0.0);
        xp1 = SCALAR_VAL(0.0);
...
#pragma omp parallel
{
    #pragma omp for nowait private(i, j, tm1, ym1, ym2)
    for (j=0; j<_PB_H; j++) {
        tm1 = SCALAR_VAL(0.0);
        ym1 = SCALAR_VAL(0.0);
        ym2 = SCALAR_VAL(0.0);
    ...
    #pragma omp for private(i, j, tp1, tp2, yp1, yp2)
    for (j=0; j<_PB_H; j++) {
        tp1 = SCALAR_VAL(0.0);
        tp2 = SCALAR_VAL(0.0);
        yp1 = SCALAR_VAL(0.0);
