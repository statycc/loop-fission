...
We also compare our technique to an alternative loop fission technique implemented in the
[ROSE compiler framework](http://rosecompiler.org/) 
[LoopProcessor](https://en.wikibooks.org/wiki/ROSE_Compiler_Framework/LoopProcessor).
